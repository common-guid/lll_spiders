...
class JsonApiSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        counts = open('/home/guid/Work/lll_presentation/lll_presentation/lll_presentation/output/TESTcat_counts.json', 'w')

        # if it is a sale page do extra processing to get item details
        for i in range(this_page, 4): #last_page+1): <<------------------------------------------
    ...
    def gather_sale_details(self, response):
        ...
        detail_skuList = open('/home/guid/Work/lll_presentation/lll_presentation/lll_presentation/output/TESTgql_sku_list.txt', 'w')
